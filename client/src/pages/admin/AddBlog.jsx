...
const AddBlog = () => {
    ...
    const generateContent = async () => {
        ...
        try {
            ...
            if (data.success) {
                quillRef.current.root.innerHTML = parse(data.content)  //Without parse, if you set innerHTML to data.content directly, it’s just raw HTML text. 
                // parse ensures it becomes proper React-renderable content and can sanitize or transform it if needed.
            } else {
        ...
        <form onSubmit={onSubmitHandler} className='flex-1 bg-blue-50/50 text-gray-600 h-full overflow-scroll'>
            <div className='bg-white w-full max-w-3xl p-4 md:p-10 sm:m-10 shadow rounded'>
                ...
                <div className='max-w-lg h-74 pb-16 sm:pb-10 pt-2 relative'>
                    ...
                    {/* //button will disabled whenever content is generating through AI */}
